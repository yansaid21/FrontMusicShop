...
const Section3 = () => {
    const partnersData = [
        ...
        { _id: 3, name: "IBANEZ", img: images.ibanez },
        ...
        { _id: 8, name: "BEHRINGER", img: images.behringer },
        ...
        { _id: 13, name: "SHURE", img: images.shure },
        { _id: 14, name: "SENNHEISER", img: images.sennheiser },
